...
namespace GarageV32.Controllers
{
    public class VehicleTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Size,Image")] VehicleType vehicleType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Size,Image")] VehicleType vehicleType)
        {
